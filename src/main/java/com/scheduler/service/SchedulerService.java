...
public class SchedulerService {
    ...
    public List<ScheduledEntry> runSchedulingPipeline() throws SQLException {
        ...
        if (projectDAO.isWeekAlreadyScheduled(nextMonday)) {
            System.out.println("  [ABORTED] This week is already scheduled.");
            System.out.println("  View it with option 4. No changes made.");
            return List.of();
        }
